		...
		try {
			if (createUserDto.password === createUserDto.confirm_password) {
				...
				if (file !== null) {
					...
					await axios.post('/users/signup', finalData).then((res) => {
		...
		<>
			...
			<form onSubmit={onSubmit} className='form'>
				...
				<div className='form-element'>
					...
					/>
					{errors.email && (
						<span className='form-text required'>{errors.email.message}</span>
					)}
				</div>
				<div className='row'>
					<div className='col'>
						<div className='form-element'>
							...
							/>
							{errors.first_name && (
								<span className='form-text required'>{errors.first_name.message}</span>
							)}
						</div>
					</div>
					<div className='col'>
						<div className='form-element'>
							...
							/>
							{errors.last_name && (
								<span className='form-text required'>{errors.last_name.message}</span>
							)}
						</div>
					</div>
				</div>
				<div className='form-element'>
					...
					/>
					{errors.password && (
						<span className='form-text required'>{errors.password.message}</span>
					)}
				</div>
				<div className='form-element'>
					...
					{errors.confirm_password && (
						<span className='form-text required'>
